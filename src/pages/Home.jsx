    ...
    <div className='bg-gray-900 min-h-screen flex items-center justify-center'>
      <div className='bg-gray-800 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center'>
        <div className='md:w-1/2 px-8'>
          <h2 className='font-bold text-2xl text-orange-400'>Login</h2>
          ...
          <div className='mt-4 text-sm flex justify-between items-center text-gray-300'>
            ...
            <Link to="/register" className='py-2 px-4 border border-gray-600 text-white rounded-xl hover:bg-gray-700 duration-200'>
              Register
            </Link>
          </div>
        </div>
